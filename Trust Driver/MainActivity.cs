...
using System;
using Trust_Driver.Adapter;
using Trust_Driver.Fragments;
        ...
        void GoOnlineButton_Click(object sender, EventArgs e)
        {
            ...
            if (availablityStatus)
            {
                ...
                alert.SetPositiveButton("Continue", (senderAlert, args) =>
                {
                    ...
                    goOnlineButton.Background = ContextCompat.GetDrawable(this, Resource.Drawable.trustdriverounded);
            ...
            else
            {
                ...
                goOnlineButton.Background = ContextCompat.GetDrawable(this, Resource.Drawable.trustdriveroundbutton_green);
            }
