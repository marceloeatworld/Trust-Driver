...
namespace Trust_Driver.Activities
{
    ...
    public class LoginActivity : AppCompatActivity
    {
        ...
        void ConnectViews()
        {
         ...
         void ClickToSignUp_Click(object sender, EventArgs e)
        {
         ...
         void LoginButton_Click(object sender, EventArgs e)
        {
         ...
         void TaskCompletionListener_Failure(object sender, EventArgs e)
        {
            CloseProgressDialogue();
            Snackbar.Make(rootView, "Login Failed", Snackbar.LengthShort).Show();
        }

         void TaskCompletionListener_Successful(object sender, EventArgs e)
        {
            CloseProgressDialogue();
