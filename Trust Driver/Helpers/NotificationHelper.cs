...
namespace Trust_Driver.Helpers
{
    public class NotificationHelper : Java.Lang.Object
    {
        ...
        public void NotifyVersion26(Context context, Android.Content.Res.Resources res, Android.App.NotificationManager manager)
        {
            ...
            var path = Android.Net.Uri.Parse("android.resource://com.companyname.trust_driver/" + Resource.Raw.alert);
            ...
            Notification.Builder builder = new Notification.Builder(context)
                ...
                .SetLargeIcon(BitmapFactory.DecodeResource(res, Resource.Drawable.profilelogo))
